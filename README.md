...
![Healthcare Analytics](https://img.shields.io/badge/Domain-Healthcare%20Analytics-success?style=for-the-badge)
![Business Intelligence](https://img.shields.io/badge/Analytics-Business%20Intelligence-orange?style=for-the-badge)
![Dashboard Project](https://img.shields.io/badge/Project-Excel%20Dashboard-red?style=for-the-badge)
...
- BMI category and cardiovascular health
...
From a Business Analyst perspective, the objectives of this analysis were:
...
- Interactive Age Group slicers
- Gender and Occupation filters
- KPI cards for patient volume and health indicators
...
# 1️⃣ Age Group vs Sleep Disorders
...
- Insomnia peaks in the 39–48 age group
- Sleep Apnea increases significantly in 49–58 and 58+
- Minimal disorder prevalence in 18–28
...
- Female patients account for approximately 66%
- Male patients account for approximately 34%
...
# 3️⃣ Stress Level vs Sleep Duration Relationship
...
- Sleep duration declines steadily as stress increases
- High-stress individuals average less than 5 hours of sleep
- Extremely high stress shows signs of chronic sleep deprivation
...
# 4️⃣ Occupational Risk Analysis
...
- Nurses and Doctors show the highest patient counts
- Engineers and Teachers follow closely
- Sales-related roles show elevated stress and sleep apnea indicators
...
# 5️⃣ Cardiovascular Risk Overlay
...
- Nearly all affected patients show high blood pressure
- Elevated heart rates align with poor sleep quality
- Sleep disorders act as a cardiovascular risk multiplier
...
- KPI cards using advanced formulas
...
# 💼 Why This Project Matters for Business Analysts

This case study reflects real BA responsibilities:

- Translating raw data into decision-ready insights
- Aligning analytics with business and operational goals
...
This project demonstrates how Advanced Excel, when applied correctly, can deliver meaningful insights in healthcare analytics.

For aspiring Business Analysts and Data Analysts, it showcases the importance of:
...
✔ Interactive stakeholder-friendly dashboard  
...
Aspiring Data Analyst | Excel | Power BI | Business Intelligence | Healthcare Analytics
